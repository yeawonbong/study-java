...
- 아래 내용과 중복임
    - Garbage Collector
        ...
        자바는 자동 메모리 정리 기능을 사용한다. Garbage Collector는 프로그램이 실행 중에 사용하지 않는 메모리를 자동해제한다. 
        
    - JVM (Java Virtual Machine)
        
        자바는 컴파일 시 JVM이 중간 다리 역할을 하여, 운영체제와 프로그램 사이에서 현재 사용되는 운영체제가 무엇인 지 판단한 뒤 해당 운영체제의 기계어로 번역을 해주기 때문에, 운영체제와 상관없이 프로그램을 실행할 수 있다. 
...
- Java 동작 과정
    ...
    ![image](https://github.com/yeawonbong/study-java/assets/75327385/cbbaa5ef-af26-47c0-b125-7d15be1a064b)
...
- OPP의 특징
    ...
    ![image](https://github.com/yeawonbong/study-java/assets/75327385/324daf59-fb67-4118-a01c-66ce2877fa6d)
